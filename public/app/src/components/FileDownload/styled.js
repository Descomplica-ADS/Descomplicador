...
import { Input as FormInput, Button } from "../inputs";
...
export const FileDownloadModal = styled(Modal)`
  z-index: 10;
  position: absolute;
  top: 50%;
  left: 50%;
...
export const FileDownloadTitle = styled.h1`
  font-size: 52pt;
  width: 100%;
  margin-left: 50px;
`;
...
export const Save = styled(Button).attrs({ children: "Baixar" })``;
